...
$routes = @(
  ...
  "/knowledge/",
  "/knowledge/apartment-mortgage-documents/",
  "/knowledge/inheritance-apartment-valuation/",
  "/knowledge/flood-damage-valuation/",
  "/knowledge/commercial-property-for-bank/",
  "/knowledge/business-sale-share-valuation/",
  "/knowledge/valuation-report-documents/",
  "/reviews/",
